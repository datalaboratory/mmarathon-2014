...
var max_time = Math.round(22742/4); // Делим на 4 для 10км результатов
var mokcodes = {};
...
var parsedata = function(){
	d3.csv("wn-data.csv", function (d){
		d.forEach(function(d,i){
			...
			d.result_time = Math.round(+d.result_time/4); // Делим на 4 для 10км результатов
			d.netto = Math.round(+d.netto/4); // Делим на 4 для 10км результатов
			...
			// Обработка подозрительных годов рождения
			+d.birthyear > 2000 ? d.birthyear = 1998 : d.birthyear = +d.birthyear;
			...
			items[i] = 
				...
				"result_steps": [
					...
					{
						"distance": 10000,  // 10000 для 10км результатов
